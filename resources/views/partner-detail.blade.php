        ...
        <section class="sol-area pos-rel light pt75 pb75">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="sol-lft col-12 col-sm-8 col-md-8">
                    ...
                    <div class="sol-rgt col-12 col-sm-4 col-md-4">

                        <div class="sol__images">
                            <?php
                            $image = str_replace('\\', '/', asset('storage/' . str_replace('.png', '-cropped.png', str_replace('.jpg', '-cropped.jpg', $partners->image))));
                            ?>
                            <div class="">
