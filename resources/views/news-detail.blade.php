            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-0">
                        <iframe width="100%" height="315" src="{{$newsevents->video_url}}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
            ...
            <div class="container">
                    ...
                    <div class="news-featured__lft col-12 col-sm-8 col-md-8">
                        <div id="demo" class="carousel slide" data-ride="carousel">
                            ...
                            <ul class="carousel-indicators">
                                @foreach(json_decode($newsevents->slider_images, true) as $key => $images)
                        ...
                        <div class="detail_share--box col-md-12 col-sm-12">
                            <div class="detail_share">
                                <ul>
                                    <li>
                                        <a href="{{$newsevents->linkedin_link}}" target="_blank">
                                            <i class="fab fa-linkedin-in"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{$newsevents->share_link}}" target="_blank">
                                            <i class="fas fa-share-alt"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <span class="view"><i class="far fa-eye"></i>{{$newsevents->views}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="row">
                    <div class="news___title col-12 col-sm-12 col-md-6">
                        <h2>{{$newsevents->name}}</h2>
                        <span class="date">{{ date('m/d/Y',strtotime($newsevents->date)) }}</span>
                    </div>


                    <div class="news__desc col-12 col-sm-12 col-md-12">
                        <p>
                            {!! $newsevents->description_1 !!}
                        </p>
                    </div>
